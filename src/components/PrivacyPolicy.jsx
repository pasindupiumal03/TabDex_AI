        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">
              TabDex AI - Bookmark & Layout Manager
            </p>
          ...
          <div className="prose prose-invert max-w-none">
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <p className="text-gray-300 leading-relaxed">
                TabDex AI - Bookmark & Layout Manager ("the Extension") is committed to protecting your privacy. 
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-8 mb-8">
              ...
              <div className="flex items-center space-x-3 bg-blue-600/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <a 
                  href="mailto:contact@tabdexai.com" 
                  className="text-blue-400 hover:text-blue-300 transition-colors"
                >
                  contact@tabdexai.com
                </a>
              </div>
            </div>
