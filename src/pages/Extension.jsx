        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300">
                Exciting features coming soon to enhance your TabDex AI experience
              </p>
            </div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="glass-effect rounded-xl p-12">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Install TabDex AI now and experience the future of bookmark management with crypto wallet integration.
              </p>
              <Button 
                ...
                onClick={() => window.open('https://chromewebstore.google.com/detail/tabdex-ai/gnoldbjnnjpmomkeefiaihihaomegaok', '_blank')}
              >
                <Download className="w-6 h-6" />
                <span>Get TabDex AI Extension</span>
              </Button>
